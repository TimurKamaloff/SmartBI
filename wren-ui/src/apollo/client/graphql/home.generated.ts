...
export const GenerateThreadResponseBreakdownDocument = gql`
  ...
  ${CommonResponseFragmentDoc}
`;
export type GenerateThreadResponseBreakdownMutationFn = Apollo.MutationFunction<
  GenerateThreadResponseBreakdownMutation,
  GenerateThreadResponseBreakdownMutationVariables
>;
...
export function useGenerateThreadResponseBreakdownMutation(
  ...
  return Apollo.useMutation<
    GenerateThreadResponseBreakdownMutation,
    GenerateThreadResponseBreakdownMutationVariables
  >(GenerateThreadResponseBreakdownDocument, options);
}
export type GenerateThreadResponseBreakdownMutationHookResult = ReturnType<
  typeof useGenerateThreadResponseBreakdownMutation
>;
export type GenerateThreadResponseBreakdownMutationResult =
  Apollo.MutationResult<GenerateThreadResponseBreakdownMutation>;
export type GenerateThreadResponseBreakdownMutationOptions =
  Apollo.BaseMutationOptions<
    GenerateThreadResponseBreakdownMutation,
    GenerateThreadResponseBreakdownMutationVariables
  >;
